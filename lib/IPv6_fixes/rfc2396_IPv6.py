...
def isIPv6(data):
    '''Check if the data is a dotted decimal IPv4 address or not?
    >>> isIPv6('2001:0db8:85a3:08d3:1319:8a2e:0370:7334') == True
    True
    >>> False == isIPv6('2001:0db8:k:08d3:1319:8a2e:0370:7334') == isIPv6('2001:0db8:85a3:08d3:8a2e:0370:7334') == isIPv6('2001::::1319:8a2e:0370:7334') == isIPv6('2001:0db8:85a3:08d3:1319:8a2e:0370:73349')
    True
    '''
    try: 
        m = socket.inet_pton(socket.AF_INET6, data)
        return True
    except:
        return False
...
class URI(object):
    ...
    def __repr__(self):
        ...
        return (self.scheme + ':' + ((user + \
          ...
          ((('['+(host if host else '') +']'+ ((':'+str(self.port)) if self.port else '')) if isIPv6(host) else ((host if host else '') + ((':'+str(self.port)) if self.port else '')) ) if host else '' ) + \
...
if __name__ == '__main__':
    print '10.2.3.4 is IPv4: '+str(isIPv4('10.2.3.4'))
    print '2001:0db8:85a3:08d3:1319:8a2e:0370:7334 is IPv6: '+str(isIPv6('2001:0db8:85a3:08d3:1319:8a2e:0370:7334'))
    print '2001:0DB8::1428:57ab is IPv6: '+str(isIPv6('2001:0DB8::1428:57ab'))
    print "Not IPv6s: "+str(False == isIPv6('2001:0db8:k:08d3:1319:8a2e:0370:7334') == isIPv6('2001:0db8:85a3:08d3:8a2e:0370:7334') == isIPv6('2001::::1319:8a2e:0370:7334') == isIPv6('2001:0db8:85a3:08d3:1319:8a2e:0370:73349'))
    print URI('sip:192.1.2.3:5060')
    print URI('sip:6000@[2620:0:2ef0:7070:250:60ff:fe03:32b7]')
    print URI('sip:[2620:0:2ef0:7070:250:60ff:fe03:32b7]')
    print URI('sip:mostro:magico@[2620:0:2ef0:7070:250:60ff:fe03:32b7]:5060').host
    print URI('sip:[2620:0:2ef0:7070:250:60ff:fe03:32b7]')
    print URI('sip:[2620:0:2ef0:7070:250:60ff:fe03:32b7]')
    print Address('"Kundan Singh" <sip:6000@[2620:0:2ef0:7070:250:60ff:fe03:32b7]:5060>').uri
    print URI('sip:[::1]')
