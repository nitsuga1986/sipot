...
from rfc2396_IPv6 import isIPv4, isIPv6, isMulticast, isLocal, isPrivate, URI, Address
...
class Stack(object):
    ...
    def uri(self): 
        ...
        return URI(((transport.type == 'tls') and 'sips' or 'sip') + ':' + (('['+(transport.host) +']') if isIPv6(transport.host) else transport.host) + ':' + str(transport.port))
